<template>
  <div class="regist-page">
    <div class="regist">
      ...
      <div>
        <el-button type='success' class='regist-button' @click='register'>注册</el-button>
        </div>
...
export default {
  ...
  methods: {
    ...
    toHome() {
      let toHome = confirm("确认要返回首页吗？")
      if (toHome === true) this.$router.push("/")
    }
  }
}
</script>
...
.regist-page {
  width: 100%;
  height: 100vh;
  background: url("../../assets/imgs/register/bg.jpg") no-repeat;
